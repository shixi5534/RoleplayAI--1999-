...
def build_orchestrator(
    ...
    return ChatOrchestrator(
        ...
        repetition_guard_enabled=s.repetition_guard_enabled,
        repetition_guard_window=s.repetition_guard_window,
        repetition_guard_max_phrases=s.repetition_guard_max_phrases,
        repetition_guard_max_retries=s.repetition_guard_max_retries,
        refine_enabled=s.refine_enabled,
        refine_temperature=s.refine_temperature,
        # 剧情图谱（独立于 lore 向量 RAG；默认关闭）
        plot_graph=services.plot_graph,
        plot_graph_enabled=s.plot_graph_enabled,
        plot_max_chunks=s.plot_max_chunks,
        plot_lexical_fallback=s.plot_lexical_fallback,
        plot_context_max_chars=s.plot_context_max_chars,
        # lore 知识图谱（第三路检索；默认关闭）
        graph_registry=services.graph_registry,
        graph_enabled=s.graph_enabled,
        graph_max_chunks=s.graph_max_chunks,
        graph_context_max_chars=s.graph_context_max_chars,
